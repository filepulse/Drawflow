export default class Drawflow {
  ...
  addNode (name, num_in, num_out, ele_pos_x, ele_pos_y, classoverride, data, html, typenode = false) {
    ...
    if(typenode === false) {
      ...
      if(parseInt(this.render.version) === 3 ) {
        //Vue 3
        let wrapper = this.render.h(this.noderegister[html].html, {...this.noderegister[html].props, ...data, id: newNodeId}, this.noderegister[html].options);
        ...
        let wrapper = new this.render({
          parent: this.parent,
          render: h => h(this.noderegister[html].html, { props: {...this.noderegister[html].props, ...data, id: newNodeId} }),
  ...
  addNodeImport (dataNode, precanvas) {
    ...
    if(dataNode.typenode === false) {
      ...
      if(parseInt(this.render.version) === 3 ) {
        //Vue 3
        let wrapper = this.render.h(this.noderegister[dataNode.html].html, {...this.noderegister[dataNode.html].props, id: dataNode.id}, this.noderegister[dataNode.html].options);
        wrapper.appContext = this.parent;
        this.render.render(wrapper,content);
